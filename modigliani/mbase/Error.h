/* Error.h - general classes (!) for error handling  */
...
#ifndef _mbase_error_h_
#define _mbase_error_h_
...
#define M_ASSERT(E) ((E) ? (void)0 : M_THROW(mbase::Error(__FILE__, __LINE__, #E)))
#define M_ASSERT_PRECOND(E) ((E) ? (void)0 : M_THROW(mbase::Precond_error(__FILE__, __LINE__, #E)))
#define M_ASSERT_POSTCOND(E) ((E) ? (void)0 : M_THROW(mbase::Postcond_error(__FILE__, __LINE__, #E)))
#define M_ASSERT_INVARIAM(E) ((E) ? (void)0 : M_THROW(mbase::Invariant_error(__FILE__, __LINE__, #E)))
#define M_ASSERT_MEM(E) ((E) ? (void)0 : M_THROW(mbase::Mem_error(__FILE__, __LINE__, #E)))
