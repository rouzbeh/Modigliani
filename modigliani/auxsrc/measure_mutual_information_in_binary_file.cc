/**
 * @file measure_mutual_information_in_binary_file.cc
 * computes the joint probability density function of two columns
 *  in binary (float) data files.
 * @author Ahmed Aldo Faisal &copy; created 10.10.2001
 * Version:  0.5
...
#include "modigliani_base/two_dim_histogram.h"
