...
*  mainly in modigliani_base (multidim_array)
*
...
void writeHeaderFileMain(ostream& fout) {
    ...
    "#include \"modigliani_base/nt_main.h\" " <<std::endl <<
    "#include \"modigliani_base/nt_types.h\" "<<std::endl <<
    "#include \"modigliani_base/nt_obj.h\"  "<< std::endl;
