/**\file ntbp_hh_current_obj.cpp - HH_current class implementation
...
/* ***      COPY AND ASSIGNMENT	***/ 
HH_current::HH_current(const HH_current & original)
:
...
const HH_current&
HH_current::operator= (const HH_current & right)
{
