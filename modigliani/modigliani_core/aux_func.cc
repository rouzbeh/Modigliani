...
modigliani_base::Real CorrectedChannelDensity(modigliani_base::Real chDensity,
                                              modigliani_base::
                                              Real                  compArea) {
  modigliani_base::Real chPerCompartment = compArea * chDensity;
  modigliani_base::Real pChFloor         =
...
Membrane_compartment* CreateCompartment(bool                  spherical,
  ...
  modigliani_core::Membrane_compartment *tmpPtr;

  if (spherical) {
    std::cout << "Spherical" <<std::endl;
    tmpPtr = new modigliani_core::Spherical_compartment(config_root.get<
                                                      double>("diameter") / 2,
    ...
    tmpPtr =
      new modigliani_core::Cylindrical_compartment(compartment_parameters.get<
                                                     double>("length"),
                                                   config_root.get<
                                                     double>("diameter"),
                                                   compartment_parameters.get<
...
modigliani_core::Membrane_compartment_sequence *
