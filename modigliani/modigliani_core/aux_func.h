 ...
 * compartment. See the documentation for CreateCompartment() for the
 ...
 *
 * @param root_config config_root  ptree containing general parameters. Usually
 * this is the root of the ptree generated by parsing a JSON file. The
 * following parameters are expected :
 ...
 * @return Vector of comaprtment indexes
 */
