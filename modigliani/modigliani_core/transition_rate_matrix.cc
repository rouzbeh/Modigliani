...
Transition_rate_matrix::Transition_rate_matrix(
    modigliani_base::Size new_num_states, modigliani_base::Real new_min,
    modigliani_base::Real new_max, modigliani_base::Real new_step)
...
void Transition_rate_matrix::setTransitionProbability(
    modigliani_base::Real voltage, modigliani_base::Size start,
...
void Transition_rate_matrix::setTransitionProbability(
    modigliani_base::Size index, modigliani_base::Size start,
    modigliani_base::Size stop, modigliani_base::Real probability) {
  _probMatrices[index * num_states * num_states + (start - 1) * num_states
      + (stop - 1)] = probability;
}

modigliani_base::Size Transition_rate_matrix::get_index(
    modigliani_base::Real voltage) {
  return (floor((voltage - min) / step + 0.5));
}

modigliani_base::Real Transition_rate_matrix::getTransitionProbability(
    modigliani_base::Real voltage, modigliani_base::Size start,
