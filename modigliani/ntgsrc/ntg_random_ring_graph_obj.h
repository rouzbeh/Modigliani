...
public:
    ...
    NTG_random_ring_graph_o(mbase::Msize nodes, mbase::Msize neighbourhoodRange, mbase::Mreal reconnectProbability, bool deterministic, const NTG_node_o & nodeProto, const NTG_edge_o & edgeProto);
