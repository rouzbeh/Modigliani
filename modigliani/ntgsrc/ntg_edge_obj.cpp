...
/* ***      CONSTRUCTORS	***/
/** Create a NTG_edge_o */
NTG_edge_o::NTG_edge_o(mbase::Mid newSource, mbase::Mid newTarget) {
	source = newSource;
	target = newTarget;
}
...
/** @short
 ...
 \bug        unknown
 */
mbase::Mreturn NTG_edge_o::SetConnection(mbase::Mid newSource,
		mbase::Mid newTarget) {
	//cerr << "NTG_edge_o::SetConnection - Talk :"<< newSource << "\t" << newTarget << std::endl;
	source = newSource;
	target = newTarget;
