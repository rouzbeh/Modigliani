/**\file ntg_neighbour_ring_graph_obj.h - NTG_neighbour_ring_graph_o class header
...
/* $Id: ntg_neighbour_ring_graph_obj.h,v 1.1 2001/06/29 13:16:58 face Exp $
* $Log: ntg_neighbour_ring_graph_obj.h,v $
...
*/
#ifndef _ntg_neighbour_ring_graph_obj_h_
...
/** @short NTG_neighbour_ring_graph_o class
	Generates a ring topology graph with symmetric (radius)-nearest neighbour
	connectivity.
\bug unknown
\warning unknown
*/
...
public:
    ...
    NTG_neighbour_ring_graph_o(NTsize nodes, NTsize neighbourhoodRange, const NTG_node_o & nodeProto, const NTG_edge_o & edgeProto);
