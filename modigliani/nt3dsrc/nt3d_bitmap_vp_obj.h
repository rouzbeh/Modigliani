...
protected:
	...
	mbase::Mreturn ResizeChild(mbase::Size_t __attribute__((unused)) newWidth,
			mbase::Size_t __attribute__((unused)) newHeight) {
...
private:
	...
	mbase::Size_t width; // bitmap , not screen size
	mbase::Size_t height; // bitmap , not screen size
};
