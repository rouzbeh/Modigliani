/**\file nt3d_position_lamp_obj.h - NT3D_position_lamp_o class header 
...
/* $Id: nt3d_position_lamp_obj.h,v 1.1.1.1 2004/12/16 01:38:36 face Exp $ 
* $Log: nt3d_position_lamp_obj.h,v $
...
* texture class added
*
* Revision 1.2  1999/07/16 15:05:15  face
* added code::^
*
...
*/
#ifndef _nt3d_position_lamp_h_
#define _nt3d_position_lamp_h_
...
/** @short NT3D_position_lamp_o class

\bug unknown
\warning unknown 
 */
class NT3D_position_lamp_o : public NT3D_lamp_o {
public:
  /***   Constructors, Copy/Assignment and Destructor  ***/  
  NT3D_position_lamp_o();
  NT3D_position_lamp_o(const NT3D_position_lamp_o & original);
  const NT3D_position_lamp_o & operator= (const NT3D_position_lamp_o & right);
  virtual ~NT3D_position_lamp_o();
  /* ***  Methods              ***/  
  /* ***  Data                 ***/  
  protected:
  /* ***  Methods              ***/
