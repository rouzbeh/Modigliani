...
private:
	...
	int nsec; //!* nanoseconds (0-999999999) UNSUPPORTED
	int sec; //!* seconds (0 - 60)
	int min; //!* minutes (0 - 59)
	int hour; //!* hours (0 - 23)
	int mday; //!* day of month (1 - 31)
	int mon; //!* month of year (0 - 11)
	int year; //!* year (! no offset to 1900 !)
	int wday; //!* day of week (Sunday = 0)
	int yday; //!* day of year (0 - 365)
	int isdst; //!* is summer time in effect?
	char zone[M_STRING_LENGTH]; //!* abbreviation of timezone name
