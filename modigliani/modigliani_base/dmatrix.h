...
modigliani_base::DMatrix(modigliani_base::DMatrix & copy) {
  row = copy.row;
  col = copy.col;
...
modigliani_base::DMatrix modigliani_base::DMatrix::operator+(modigliani_base::
                                                             DMatrix & right) {
...
modigliani_base::DMatrix::operator=(modigliani_base::
                                    DMatrix & right) {
  if (this == &right) {
    return (*this);
  } else {
