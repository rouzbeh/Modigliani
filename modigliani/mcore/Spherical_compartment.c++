...
Spherical_compartment::Spherical_compartment(NTreal newRadius, NTreal newCm)
:
...
/* ***      COPY AND ASSIGNMENT	***/ 
Spherical_compartment::Spherical_compartment(const Spherical_compartment & original)
:
