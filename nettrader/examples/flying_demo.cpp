...
/* $Id: flying_demo.cpp,v 1.2 2003/06/20 13:25:55 face Exp $
 * $Log: flying_demo.cpp,v $
 ...
 * *** empty log message ***
 *
 * Revision 1.2  2000/10/03 08:29:56  face
 * *** empty log message ***
 *
...
int main(void)
{
    ...
    NT3D_sphere_o sphere(NT_OriginVec3(), 1);
