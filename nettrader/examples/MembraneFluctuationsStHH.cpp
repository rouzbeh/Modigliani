...
/* $Id: MembraneFluctuationsStHH.cpp,v 1.2 2003/06/20 13:25:55 face Exp $
 * $Log: MembraneFluctuationsStHH.cpp,v $
...
int main(void)
{
    ...
    ofstream file("time_resting_potential_fluctuation_sga_1h.bin.dat", ios::binary);
    ofstream file2("interspike_intervals_at_resting_potential_sga_1h.dat");
    ...
    for (NTint lt=1; lt< 6000000.0/NTBP_TIMESTEP; lt++) {
        ...
        file.write( reinterpret_cast<char*>(data), 2*sizeof(float) );
