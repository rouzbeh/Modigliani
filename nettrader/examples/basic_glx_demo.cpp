...
/* $Id: basic_glx_demo.cpp,v 1.2 2003/06/20 13:25:55 face Exp $
 * $Log: basic_glx_demo.cpp,v $
...
public :
            ...
            moon2(NT_OriginVec3(), 0.4)
    {
        ...
        */
        ...
        earth.SetTexture( new NT3D_worldmap_texture_o );
        moon.SetTexture( new NT3D_moonmap_texture_o );
        moon2.SetTexture( new NT3D_file_texture_o("veilmap_128_64.tga"));
