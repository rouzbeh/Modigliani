...
//
//
///* $Id: diffusion_vs_wave_signalling.cpp,v 1.3 2003/06/20 13:25:55 face Exp $
//* $Log: diffusion_vs_wave_signalling.cpp,v $
...
//    cout << "Data format is : timeInMS, inpCurrent, peakPos, total cumul	leakCurr, total cumul naCurr, toal cumul kCurr 	" << endl;
...
//            naCurr += oModel.AttachedCurrent(ll+1,2);
//            kCurr += oModel.AttachedCurrent(ll+1,3);
//        }
//
...
//            file.write( reinterpret_cast<char*>(&naCurr), sizeof(float));
//            file.write( reinterpret_cast<char*>(&kCurr), sizeof(float));
//        }
//
