...
/* $Id: channel_density_vs_noise_variance_third_version.cpp,v 1.2 2003/06/20 13:25:55 face Exp $
 * $Log: channel_density_vs_noise_variance_third_version.cpp,v $
...
int main(void)
{
    ...
    ofstream file("voltage_variance_vs_channel_density_sga_1min_third_run.dat");
    ofstream file2("interspike_intervals_at_various_channel_densities_sga_1min_third_run.dat");
    ...
    NTsize densities[8] = {500, 600, 750, 900, 2200, 2500, 3000, 400};
