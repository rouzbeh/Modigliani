...
/* $Id: nt3d_drv_vp_obj.h,v 1.1 2001/06/29 13:16:55 face Exp $
...
public:
    ...
    /* ***  Methods              ***/
    virtual NTreturn Open(NT3D_vp_spec_o newWinSpec) {
    ...
    virtual void Init() {};
    virtual NTreturn Resize(NTsize width, NTsize height) {
        NT_CERR(5,"NT3D_drv_vp_o::Resize()");
        return NT_FAIL;
    }
    virtual void Redraw() {};
    virtual NT3D_bitmap_o View2Bitmap() {
        NT_CERR(3,"NT3D_bitmap_o NT3D_drv_vp_o::View2Mem - Warning : Method should be implemented in derived class .");
        NT3D_bitmap_o oTmp;
        return oTmp;
    }
    ...
    virtual NTsize _width() {
        NT_CERR(1,"NT3D_drv_vp_o::_width() - Error : Should be implemented in derived class");
        return 0;
    }
    virtual NTsize _height() {
        NT_CERR(1,"NT3D_drv_vp_o::_height() - Error : Should be implemented in derived class");
        return 0;
    }
