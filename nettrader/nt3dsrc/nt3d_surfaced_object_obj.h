...
/* $Id: nt3d_surfaced_object_obj.h,v 1.1 2001/06/29 13:16:55 face Exp $
...
protected:
    ...
    virtual void ControlSurfacedObj(NT3Dcontroller cntrl , NTint value) {
