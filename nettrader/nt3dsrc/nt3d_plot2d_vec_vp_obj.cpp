...
/* $Id: nt3d_plot2d_vec_vp_obj.cpp,v 1.1 2001/06/29 13:16:55 face Exp $
...
/* ***      COPY AND ASSIGNMENT	***/
NT3D_plot2d_vec_vp_o::NT3D_plot2d_vec_vp_o(const NT3D_plot2d_vec_vp_o & original)
{
...
*/
NTreturn
NT3D_plot2d_vec_vp_o::SetData(const vector<NTreal> & newDataVec)
{
    if (dim > 0) NT_ASSERT(newDataVec.size() == dim );
    else set_dim(newDataVec.size());
    for (NTsize ll = 0; ll < dim; ll++) {
