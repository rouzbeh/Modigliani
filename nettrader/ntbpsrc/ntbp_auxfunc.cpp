...
NTreal 
NTBP_corrected_channel_density(NTreal chDensity, NTreal compArea)
{
     ...
     NTreal indChDensity = (uniRnd.RndVal() >  pChFloor ? 
...
NTBP_create_na_channel_ptr(NTsize sodiumModel, NTsize sodiumAlg, NTreal sodiumDensity, NTreal sodiumConductance, NTreal q10, NTreal temperature, NTreal area) {

NTreal indSodiumDensity = NTBP_corrected_channel_density(sodiumDensity, area);
...
switch (sodiumModel) {
	case 1:
		/* SGA */
		tmpNaPtr =
		new NTBP_multi_sodium_current_o (area,
					indSodiumDensity, pow(3,(temperature-6.3)/10.0)*sodiumConductance*1e-9	/* mSiemens per channel */
					);
	cout<< "Using SGA Na model." << endl;
			...
			case 2:
					/* hRanvier */
		tmpNaPtr =
		new NTBP_hranvier_sodium_multi_current_o (area,
	...
	cout<< "Using human Ranvier Na model." << endl;
			...
			case 3:
					/* COLBERTAXONAL */
	tmpNaPtr =
		new NTBP_colbert_axonal_sodium_multi_current_o (area,
					indSodiumDensity, pow(1.4,(temperature-24.0)/10.0)*sodiumConductance*1e-9	/* mSiemens per channel */
					);
	cout<< "Using Colbert-Axonal Na model." << endl;
			...
			case 4:
					/* PATLAK */
	tmpNaPtr =
	new NTBP_patlak_sodium_multi_current_o (area,
	indSodiumDensity, sodiumConductance*1e-9	/* mSiemens per channel */
	);
	cout<< "Using Patlak Na model." << endl;
	break;
	default: cerr <<"Axonsimulator-v2 - Error  : Invalid Na channel model specified. Exiting."; exit(NT_PARAM_OUT_OF_RANGE); break;
	}
switch (sodiumAlg) {
	case 1:
	...
	tmpNaPtr->SetSimulationMode(NTBP_BINOMIALPOPULATION);
		...
		break;
	default: cerr <<"Axonsimulator-v2 - Error  : Invalid Na channel algorithm  specified. Exiting."; exit(NT_PARAM_OUT_OF_RANGE); break;
	}
...
NTBP_membrane_current_o * 
NTBP_create_k_channel_ptr(NTsize potassiumModel, NTsize potassiumAlg, NTreal potassiumDensity, NTreal potassiumConductance, NTreal q10, NTreal temperature, NTreal area)
{

NTreal indPotassiumDensity = NTBP_corrected_channel_density(potassiumDensity, area);
    ...
    switch (potassiumModel) {
           case 1:
                /* SGA */
                 tmpKPtr =
                new NTBP_multi_potassium_current_o(area,NTBP_SGA_SCHNEIDMAN,indPotassiumDensity);
              ...
              cout<< "Using human Ranvier K model." << endl;
     			...
     			case 3:
   					  /* COLBERT AXONAL */
               tmpKPtr =
                 new NTBP_colbert_axonal_potassium_multi_current_o(area,indPotassiumDensity, potassiumConductance*1e-9	/* mSiemens per channel */ );
              cout<< "Using Colbert-Axonal K model." << endl;
   						break;
         case 4:
               /* K-MULTI */
               tmpKPtr =
                 new NTBP_potassium_multi_current_o(area,
                                            indPotassiumDensity,
               ...
               break;
        default: cerr <<"Axonsimulator-v2 - Error : Invalid K channel model "<< potassiumModel << " specified. Exiting."; exit(NT_PARAM_OUT_OF_RANGE); break;
     	}
      switch (potassiumAlg) {
          case 1:
          ...
          case 5:
               tmpKPtr->SetSimulationMode(NTBP_BINOMIALPOPULATION);
                  ...
                  break;
         default: cerr <<"Axonsimulator-v2 - Error  : Invalid K channel algorithm  specified. Exiting."; exit(NT_PARAM_OUT_OF_RANGE); break;
         }
       tmpKPtr->Set_q10 (q10);
