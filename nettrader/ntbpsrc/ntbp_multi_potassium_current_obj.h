/**\file ntbp_multi_potassium_current_obj.h - NTBP_multi_potassium_current_o class header 
...
/* $Id: ntbp_multi_potassium_current_obj.h,v 1.1.1.1 2004/12/16 01:38:36 face Exp $ 
* $Log: ntbp_multi_potassium_current_obj.h,v $
...
*/
#ifndef _ntbp_multi_potassium_current_obj_h_ 
#define _ntbp_multi_potassium_current_obj_h_ 
...
/** @short NTBP_multi_potassium_current_o class */
...
class NTBP_multi_potassium_current_o : public NTBP_multi_current_o {
public:
...
NTreal AlphaN( NTreal voltage /* in mV */ ) { return (10.0 - voltage)/(100.0 * ( exp( 1.0 - voltage/10.0 ) - 1.0) ); }
NTreal BetaN ( NTreal voltage /* in mV */ ) { return 0.125 * exp(-voltage / 80.0); }
  /**  */
...
#endif /* _ntbp_multi_potassium_current_obj_h_ */ 
