...
// */
//
///* $Id: ntbp_multi_potassium_current_obj.cpp,v 1.1.1.1 2004/12/16 01:38:36 face Exp $
...
//NTBP_multi_potassium_current_o::NTBP_multi_potassium_current_o(NTreal newArea,
//		enum NTBPdelayedPotassiumRectifierType newType, NTreal newDensity,
//		NTreal vBase, NTreal reversalPotential) :
...
//	default:
//		cerr
//				<< "NTBP_multi_potassium_current_o::NTBP_multi_potassium_current_o - Warning : current type not implemented yet."
//				<< endl;
//		break;
//	};
//
...
//		const NTBP_multi_potassium_current_o & original) :
...
//NTBP_multi_potassium_current_o::operator=(
//		const NTBP_multi_potassium_current_o & right) {
//	if (this == &right)
...
// */
//
//inline void NTBP_multi_potassium_current_o::ComputeRateConstants() {
//	NTreal vM = voltage;
...
//
///** in kHz */
//inline NTreal NTBP_multi_potassium_current_o::ComputeChannelStateTimeConstant() const {
//	return channelsPtr->ComputeChannelStateTimeConstant(voltage);
//}
//
///** No descriptions */
//inline NTreal NTBP_multi_potassium_current_o::OpenChannels() const {
...
//	default:
//		cerr
//				<< "NTBP_multi_potassium_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels()."
//				<< endl;
//		return 0;
//	}
//}
//
//inline NTreal NTBP_multi_potassium_current_o::ComputeConductance() {
//	switch (_simulationMode()) {
//	case NTBP_GILLESPIE:
//	case NTBP_SINGLECHANNEL:
//	case NTBP_BINOMIALPOPULATION:
...
//	default:
//		cerr
//				<< "NTBP_multi_potassium_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance."
//				<< endl;
//		return 0;
//	}
//}
...
//	default:
//		cerr
//				<< "NTBP_multi_potassium_current_o::StepCurrent - ERROR : Unsupported simulation mode."
//				<< endl;
