/**\file ntbp_migliore_sodium_multi_current_obj.cpp - squid giant axon sodium conducta nce class implementation
...
/* $Id: ntbp_migliore_sodium_multi_current_obj.cpp,v 1.1.1.1 2004/12/16 01:38:36 face Exp $
* $Log: ntbp_migliore_sodium_multi_current_obj.cpp,v $
...
*/
#include "ntbp_migliore_sodium_multi_current_obj.h"
NT_gaussian_rnd_dist_o NTBP_migliore_sodium_multi_current_o::normalRnd;
bool NTBP_migliore_sodium_multi_current_o::initTableLookUp = false;
NTreal NTBP_migliore_sodium_multi_current_o::alphaMvec[15000];
NTreal NTBP_migliore_sodium_multi_current_o::betaMvec[15000];
NTreal NTBP_migliore_sodium_multi_current_o::alphaHvec[15000];
NTreal NTBP_migliore_sodium_multi_current_o::betaHvec[15000];


        

/* ***      CONSTRUCTORS	***/
/** Create a NTBP_migliore_sodium_multi_current_o */
NTBP_migliore_sodium_multi_current_o::NTBP_migliore_sodium_multi_current_o(NTreal newArea, NTreal newDensity, NTreal newConductivity, NTreal newVBase)
:
...
/* ***      COPY AND ASSIGNMENT	***/
NTBP_migliore_sodium_multi_current_o::NTBP_migliore_sodium_multi_current_o(const NTBP_migliore_sodium_multi_current_o & original)
:
...
const NTBP_migliore_sodium_multi_current_o&
NTBP_migliore_sodium_multi_current_o::operator= (const NTBP_migliore_sodium_multi_current_o & right)
{
...
/* ***      DESTRUCTOR		***/
NTBP_migliore_sodium_multi_current_o::~NTBP_migliore_sodium_multi_current_o()
{
	delete channelsPtr;
}
...
/** @short
   ...
   \bug        unknown
 */
inline NTreturn NTBP_migliore_sodium_multi_current_o::StepCurrent()
{
//	cerr << "NTBP_migliore_sodium_multi_current_o::StepCurrent()" << endl;
	NTreal tmpM = 0;
	NTreal tmpH = 0;	
	NTsize counter = 0;
	...
	switch(_simulationMode()) {
		...
		case NTBP_DETERMINISTIC:
				...
				break;
		default:
				cerr << "NTBP_migliore_sodium_multi_current_o::StepCurrent - ERROR : Unsupported simulation mode." << endl;
...
inline void
NTBP_migliore_sodium_multi_current_o::ComputeRateConstants(NTreal vM /* in mV */)
{
	//	cerr << "NTBP_migliore_sodium_multi_current_o::ComputeRateConstants" << endl;
...
/** No descriptions */
inline NTreal
NTBP_migliore_sodium_multi_current_o::OpenChannels() const
{
	switch(_simulationMode()) {
		case NTBP_BINOMIALPOPULATION:
		case NTBP_GILLESPIE:
		...
		default:
				cerr << "NTBP_migliore_sodium_multi_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels." << endl;
				return 0;			}	
}


inline NTreal NTBP_migliore_sodium_multi_current_o::ComputeConductance()
{
//  cerr << "NTBP_migliore_sodium_multi_current_o::ComputeConductance" << endl;
	switch(_simulationMode()) {
		case NTBP_BINOMIALPOPULATION:
		case NTBP_GILLESPIE:
		case NTBP_SINGLECHANNEL:
		...
		default:
				cerr << "NTBP_migliore_sodium_multi_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance." << endl;
				return 0;
	}
}
...
inline NTreal
NTBP_migliore_sodium_multi_current_o::ComputeChannelStateTimeConstant() const
{
  // cerr << "NTBP_migliore_sodium_multi_current_o::ComputeChannelStateTimeConstant()" << endl;
	return channelsPtr->ComputeChannelStateTimeConstant();
}

void NTBP_migliore_sodium_multi_current_o::ShowParam() const
{
