...
/* $Id: ntbp_hranvier_sodium_multi_current_obj.cpp,v 1.1.1.1 2004/12/16 01:38:36 face Exp $
* $Log: ntbp_hranvier_sodium_multi_current_obj.cpp,v $
...
/* ***      COPY AND ASSIGNMENT	***/
NTBP_hranvier_sodium_multi_current_o::NTBP_hranvier_sodium_multi_current_o(const NTBP_hranvier_sodium_multi_current_o & original)
:
...
NTBP_hranvier_sodium_multi_current_o::operator= (const NTBP_hranvier_sodium_multi_current_o & right)
{
...
//	cerr << "NTBP_hranvier_sodium_multi_current_o::StepCurrent()" << endl;
	...
	switch(_simulationMode()) {
		...
		case NTBP_DETERMINISTIC:
				...
				break;
		default:
				cerr << "NTBP_hranvier_sodium_multi_current_o::StepCurrent - ERROR : Unsupported simulation mode." << endl;
...
inline void
NTBP_hranvier_sodium_multi_current_o::ComputeRateConstants(NTreal vM /* in mV */)
{
...
/** No descriptions */
inline NTreal
NTBP_hranvier_sodium_multi_current_o::OpenChannels() const
{
	switch(_simulationMode()) {
		case NTBP_BINOMIALPOPULATION:
		case NTBP_GILLESPIE:
		...
		default:
				cerr << "NTBP_hranvier_sodium_multi_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels." << endl;
				return 0;			}	
}
...
//  cerr << "NTBP_hranvier_sodium_multi_current_o::ComputeConductance" << endl;
	switch(_simulationMode()) {
		...
		default:
				cerr << "NTBP_hranvier_sodium_multi_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance." << endl;
				return 0;
	}
}
...
inline NTreal
NTBP_hranvier_sodium_multi_current_o::ComputeChannelStateTimeConstant() const
{
