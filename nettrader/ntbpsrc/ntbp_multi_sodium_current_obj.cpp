...
/* $Id: ntbp_multi_sodium_current_obj.cpp,v 1.8 2003/01/30 17:13:44 face Exp $
...
/* ***      COPY AND ASSIGNMENT	***/
NTBP_multi_sodium_current_o::NTBP_multi_sodium_current_o(const NTBP_multi_sodium_current_o & original)
        :
...
NTBP_multi_sodium_current_o::operator= (const NTBP_multi_sodium_current_o & right)
{
...
//	cerr << "NTBP_multi_sodium_current_o::StepCurrent()" << endl;
    ...
    case NTBP_DETERMINISTIC:
        ...
        break;
    default:
        cerr << "NTBP_multi_sodium_current_o::StepCurrent - ERROR : Unsupported simulation mode." << endl;
...
inline void
NTBP_multi_sodium_current_o::ComputeRateConstants(NTreal vM /* in mV */)
{
//	cerr << "NTBP_multi_sodium_current_o::ComputeRateConstants" << endl;
...
*/
inline NTreal
NTBP_multi_sodium_current_o::OpenChannels() const
{
    switch (_simulationMode()) {
    case NTBP_BINOMIALPOPULATION:
    case NTBP_GILLESPIE:
    ...
    case NTBP_DETERMINISTIC:
        ...
        break;
    default:
        cerr << "NTBP_multi_sodium_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels." << endl;
        return 0;
    }
}
...
//  cerr << "NTBP_multi_sodium_current_o::ComputeConductance" << endl;
    ...
    default:
        cerr << "NTBP_multi_sodium_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance." << endl;
        return 0;
    }
}
...
inline NTreal
NTBP_multi_sodium_current_o::ComputeChannelStateTimeConstant() const
{
