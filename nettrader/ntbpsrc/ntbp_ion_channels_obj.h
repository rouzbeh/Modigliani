...
/* $Id: ntbp_ion_channels_obj.h,v 1.3 2002/03/13 19:23:27 face Exp $
...
public:
    ...
    bool GillespieStep();
    virtual NTreturn BinomialStep() {
        cerr << "NTBP_ion_channels_o::BinomialStep was not derived." << endl;
        return NT_NOT_IMPLEMENTED;
    }
    virtual bool ComputeGillespieStep(NTsize channelStateId) {
        cerr << "NTBP_ion_channels::ComputeGillespieStep - Error : Should be overridden by derived class." << endl;
        return false;
    }
