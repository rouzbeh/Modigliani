...
/* $Id: ntbp_colbert_axonal_potassium_multi_current_obj.cpp,v 1.1.1.1 2004/12/16 01:38:36 face Exp $
* $Log: ntbp_colbert_axonal_potassium_multi_current_obj.cpp,v $
...
NT_gaussian_rnd_dist_o NTBP_colbert_axonal_potassium_multi_current_o::normalRnd;
bool NTBP_colbert_axonal_potassium_multi_current_o::initTableLookUp = false;
NTreal NTBP_colbert_axonal_potassium_multi_current_o::alphaNvec[15000];
NTreal NTBP_colbert_axonal_potassium_multi_current_o::betaNvec[15000];

/* ***      CONSTRUCTORS	***/
/** Create a NTBP_colbert_axonal_potassium_multi_current_o */
NTBP_colbert_axonal_potassium_multi_current_o::NTBP_colbert_axonal_potassium_multi_current_o(
			NTreal newArea,
			NTreal newDensity,
...
/* ***      COPY AND ASSIGNMENT	***/
NTBP_colbert_axonal_potassium_multi_current_o::NTBP_colbert_axonal_potassium_multi_current_o(const NTBP_colbert_axonal_potassium_multi_current_o & original)
:
...
NTBP_colbert_axonal_potassium_multi_current_o::operator= (const NTBP_colbert_axonal_potassium_multi_current_o & right)
{
...
/* ***  PROTECTED                         ***   */
/*NTreturn DEPRECATED
NTBP_colbert_axonal_potassium_multi_current_o::SetDensityChild(NTreal channelDensity)// in channels/muMeter^2
{
...
/** in kHz */
inline NTreal
NTBP_colbert_axonal_potassium_multi_current_o::ComputeChannelStateTimeConstant() const
{
...
/** No descriptions */
inline NTreal
NTBP_colbert_axonal_potassium_multi_current_o::OpenChannels() const
{
	switch(_simulationMode()) {
		...
		default:
				cerr << "NTBP_colbert_axonal_potassium_multi_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels()." << endl;
				return 0;			}	
}


inline NTreal
NTBP_colbert_axonal_potassium_multi_current_o::ComputeConductance()
{
	switch(_simulationMode()) {
		case NTBP_GILLESPIE:
		case NTBP_SINGLECHANNEL:
...
//					mean = uniformRnd.RndVal()
		...
		default:
				cerr << "NTBP_colbert_axonal_potassium_multi_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance." << endl;
				return 0;
	}
}


inline NTreturn NTBP_colbert_axonal_potassium_multi_current_o::StepCurrent()
{
	vector < NTreal > vec(2);
	vec[0] = alphaN;
	vec[1] = betaN;
	...
	switch(_simulationMode()) {
		...
		case NTBP_DETERMINISTIC:
				...
				break;
		default:
				cerr << "NTBP_colbert_axonal_potassium_multi_current_o::StepCurrent - ERROR : Unsupported simulation mode." << endl;
				return NT_PARAM_UNSUPPORTED;
	}
}


void NTBP_colbert_axonal_potassium_multi_current_o::ShowParam() const
{
