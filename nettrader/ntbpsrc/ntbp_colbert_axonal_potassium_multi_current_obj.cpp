...
NTBP_colbert_axonal_potassium_multi_current_o::NTBP_colbert_axonal_potassium_multi_current_o(
	...
	NTBP_multi_current_o(reversalPotential /* mV */, newDensity, newArea,
			newChannelConductance, newVBase) {
	NT_ASSERT (newArea >= 0);
...
inline void NTBP_colbert_axonal_potassium_multi_current_o::ComputeRateConstants(
		NTreal vM) {
...
/** No descriptions */
inline NTreal NTBP_colbert_axonal_potassium_multi_current_o::OpenChannels() const {
	...
	default:
		cerr
				<< "NTBP_colbert_axonal_potassium_multi_current_o::OpenChannels - ERROR : Unsupported simulation mode for OpenChannels()."
				<< endl;
		return 0;
	}
}

inline NTreal NTBP_colbert_axonal_potassium_multi_current_o::ComputeConductance() {
	switch (_simulationMode()) {
	case NTBP_GILLESPIE:
	case NTBP_SINGLECHANNEL:
	case NTBP_BINOMIALPOPULATION:
	...
	default:
		cerr
				<< "NTBP_colbert_axonal_potassium_multi_current_o::ComputeConductance - ERROR : Unsupported simulation mode for ComputeConductance."
				<< endl;
		return 0;
	}
}
...
inline NTreturn NTBP_colbert_axonal_potassium_multi_current_o::StepCurrent() {
	...
	default:
		cerr
				<< "NTBP_colbert_axonal_potassium_multi_current_o::StepCurrent - ERROR : Unsupported simulation mode."
				<< endl;
