...
public:
    ...
    const NTBP_membrane_current_o & operator= (const NTBP_membrane_current_o & right);
    ...
    virtual NTreal OpenChannels() const {
        cerr <<"NTBP_membrane_current_o::OpenChannels() - Error : Not Implemented." << endl;
        return -42;
    }
    /** Total number of ionic channels */
    virtual NTreal NumChannels() const {
        cerr <<"NTBP_membrane_current_o::NumChannels() - Error : Not Implemented." << endl;
        return -42;
    }
    /** Number of open over total number of channels */
    virtual NTreal OpenChannelsRatio() const {
        cerr <<"NTBP_membrane_current_o::OpenChannelsRatio() - Error : Not Implemented." << endl;
        return -42;
    }
    ...
    virtual NTreal ComputeChannelStateTimeConstant() const {
        cerr << "NTBP_membrane_current_o::ComputeChannelStateTimeConstant - Error : Method should be overridden by a stochastic current class or not be called for a deterministic current class."<< endl;
        return 0;
    }
    ...
    virtual bool ComputeGillespieStep() {
        cerr << "NTBP_membrane_current_o::ComputeGillespieStep- Error : Method should be overridden by a stochastic current class or not be called for a deterministic current class."<< endl;
