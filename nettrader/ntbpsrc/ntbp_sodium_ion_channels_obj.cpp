...
/* $Id: ntbp_sodium_ion_channels_obj.cpp,v 1.7 2003/01/30 17:13:45 face Exp $
...
bool NTBP_sodium_ion_channels_o::ComputeGillespieStep(NTsize stateId)
{
    ...
    {
    case 1:
        if (val < p12/statePersistenceProbVec[0]) {
            stateCounterVec[2]++;
            stateCounterVec[1]--;
        }
        else  {
        ...
        break;
    case 2:
        if (val < p23/statePersistenceProbVec[1]) {
            stateCounterVec[3]++;
            stateCounterVec[2]--;
        }
        else if (val < t26/statePersistenceProbVec[1]) {
            stateCounterVec[6]++;
            stateCounterVec[2]--;
        }
        else {
        ...
        break;
    case 3:
        if (val < p34/statePersistenceProbVec[2]) {
            stateCounterVec[4]++;
            stateCounterVec[3]--;
        }
        else if (val < t37/statePersistenceProbVec[2]) {
            stateCounterVec[7]++;
            stateCounterVec[3]--;
        }
        else {
        ...
        break;
    case 4:
        if (val < p43/statePersistenceProbVec[3]) {
            stateCounterVec[3]++;
            stateCounterVec[4]--;
        }
        else  {
        ...
        break;
    case 5:
        if (val < p56/statePersistenceProbVec[4]) {
            stateCounterVec[6]++;
            stateCounterVec[5]--;
        }
        else {
        ...
        break;
    case 6:
        if (val < p67/statePersistenceProbVec[5]) {
            stateCounterVec[7]++;
            stateCounterVec[6]--;
        }
        else if (val < t62/statePersistenceProbVec[5]) {
            stateCounterVec[2]++;
            stateCounterVec[6]--;
        }
        else {
        ...
        break;
    case 7:
        if (val < p78/statePersistenceProbVec[6]) {
            stateCounterVec[8]++;
            stateCounterVec[7]--;
        }
        else if (val < t73/statePersistenceProbVec[6]) {
            stateCounterVec[3]++;
            stateCounterVec[7]--;
        }
        else  {
        ...
        break;
    case 8:
        if (val < p87/statePersistenceProbVec[7]) {
            stateCounterVec[7]++;
            stateCounterVec[8]--;
        }
        else {
