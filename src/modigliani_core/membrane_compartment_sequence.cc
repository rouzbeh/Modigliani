...
modigliani_base::ReturnEnum Membrane_compartment_sequence::PushBack(
  ...
  if (compartment_vec_.size() !=
      num_compartments_) return modigliani_base::ReturnEnum::FAIL;
...
modigliani_base::ReturnEnum Membrane_compartment_sequence::InjectCurrent(
  ...
  if ((compartmentId < 1) ||
      (compartmentId >
       num_compartments())) return modigliani_base::ReturnEnum::PARAM_OUT_OF_RANGE;
...
modigliani_base::Real Membrane_compartment_sequence::
...
std::vector<modigliani_base::Real>Membrane_compartment_sequence::
