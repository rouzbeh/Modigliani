...
namespace modigliani_core {
   ...
   */
  modigliani_base::Real LengthConstantPassiveCable(
      modigliani_base::Real diameter,
      modigliani_base::Real rAxoplasmic,
      modigliani_base::Real gLeak);

  /**
   * @brief Base class for all objects in modigliani_core
   */
  ...
  private:
    ...
    modigliani_base::Real timestep_;  // time step size in msec;
};
}  // namespace modigliani_core
