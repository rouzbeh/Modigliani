 ...
 */
    Lua_based_stochastic_voltage_gated_channel(
        modigliani::Real newArea, modigliani::Real newDensity,
        modigliani::Real newConductivity,
        modigliani::Real reversalPotential,
        modigliani::Real newTimeStep, modigliani::Real newTemperature,
        string fileName);
 ...
 */
    virtual modigliani::Real ComputeTimeConstant() const;
 ...
 */
    virtual modigliani::Real OpenChannels() const override;
  ...
  private:
    ...
    static std::map<string, modigliani::Size> number_of_states_map;
    static std::map<string, double> base_temperature_map;
    static std::map<string, std::vector<modigliani::Size> > open_states_map;
    Ion_channels* channels_ptr_;
    static modigliani::Real lua_get_real(lua_State* L, string name);
